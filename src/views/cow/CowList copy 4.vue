...
function calculateAgeAndClass(dateStr, cow) {
  ...
  if (remainingMonths > 0) {
    ...
    ageString += `${remainingMonths}m`
  }
  if (!ageString) ageString = '<1m'
...
function getGenderBadge(gender) {
  return gender === 'Female' 
    ? { color: 'pink', text: 'Female', icon: '♀' }
    : { color: 'blue', text: 'Male', icon: '♂' }
}
        ...
        <CCard class="shadow-sm border-0">
          ...
          <CCardHeader class="bg-white border-bottom">
            <div class="d-flex justify-content-between align-items-center">
              <div>
                <h5 class="mb-1">
                  <i class="fas fa-list-ul me-2 text-primary"></i>Cattle Inventory
                </h5>
                <small class="text-muted">Manage your cattle records</small>
              </div>
              ...
              <CTable hover class="mb-0 modern-table">
                <CTableHead class="table-light">
                  <CTableRow>
                    ...
                    <CTableHeaderCell class="sortable" @click="sortBy('date_of_birth')">
                ...
                <CTableBody>
                  <CTableRow v-for="cow in paginatedCows" :key="cow.id" class="table-row">
                    ...
                    <CTableDataCell>
                      <small class="text-muted">{{ formatDate(cow.date_of_birth) }}</small>
                    </CTableDataCell>
                    <CTableDataCell>
                      <span class="fw-semibold">{{ calculateAgeAndClass(cow.date_of_birth, cow).age }}</span>
                    </CTableDataCell>
                    <CTableDataCell>
                      <CBadge 
                        :color="getGenderBadge(cow.gender).color" 
                        variant="outline" 
                        class="px-2 py-1"
                      >
                        {{ getGenderBadge(cow.gender).icon }} {{ cow.gender }}
                      </CBadge>
                    </CTableDataCell>
                    <CTableDataCell>
                      <router-link 
                      ...
                      >
                        <CBadge color="secondary" variant="outline" class="px-2 py-1">
        ...
        <CTabContent>
          ...
          <CTabPane :visible="activeTab === 'details'">
            <CRow class="g-3">
              ...
              <CCol md="6">
                <CFormLabel for="gender" class="fw-semibold">Gender *</CFormLabel>
                <CFormSelect
                  id="gender"
              ...
              <CCol md="6">
                <CFormLabel for="breed" class="fw-semibold">Breed *</CFormLabel>
                <CFormSelect
                  id="breed"
              ...
              <CCol md="6">
                <CFormLabel for="from_farm" class="fw-semibold">Origin *</CFormLabel>
                <CFormSelect
                  id="from_farm"
              ...
              <CCol md="6" v-if="currentCow.from_farm === 'no'">
                <CFormLabel for="source_location" class="fw-semibold">Source Location *</CFormLabel>
              ...
              <CCol md="6">
                <CFormLabel for="pasture" class="fw-semibold">Pasture *</CFormLabel>
                <CFormSelect
                  id="pasture"
              ...
              <CCol cols="12" v-if="isEditing && currentCow.image && typeof currentCow.image === 'string'">
