...
if (!block.value && !loading.value) {
  block.value = {
    ...
    description: 'This is the main northern block of the farm, containing premium grazing areas with natural water sources.',
    status: '1',
    created_at: '2024-01-15T10:30:00Z',
    updated_at: '2024-01-20T14:45:00Z',
    area: '25.5 hectares',
    soil_type: 'Clay loam',
    last_inspection: '2024-01-25T09:15:00Z'
  }
  loading.value = false
}
</script>
              ...
              <CRow class="g-4">
                <CCol md="2">
                    ...
                    <CListGroupItem class="border-0 ps-0">
                        ...
                        <span class="text-muted small">Block Name: <span class="fw-bold">{{ block.name }}</span></span>
                ...
                <CCol md="2">
                    ...
                    <CListGroupItem class="border-0 ps-0">
                        <div class="d-flex justify-content-between">
                        <span class="text-muted small">Block Code: <span class="fw-bold">{{ block.block_code }}</span></span>
                ...
                <CCol md="2">
                    ...
                    <CListGroupItem class="border-0 ps-0">
                        <div class="d-flex justify-content-between">
                        <span class="text-muted small">Farm:  <span class="fw-bold">{{ block.farm?.name }}</span></span>
                        </div>
                    </CListGroupItem>
                    </CListGroup>
                </CCol>
                ...
                <CCol md="2">
                    ...
                    <CListGroupItem class="border-0 ps-0">
                        <div class="d-flex justify-content-between">
                        <span class="text-muted small">Country: <span class="fw-bold">{{ block.farm?.country?.country }}</span></span>
                ...
                <CCol md="2">
                    ...
                    <CListGroupItem class="border-0 ps-0">
                        <div class="d-flex justify-content-between">
                        <span class="text-muted small">Status: <CBadge :color="statusBadge.color">{{ statusBadge.text }}</CBadge></span>
      ...
      <CRow class="g-4 mt-2">
        ...
        <CCol lg="4">
          <CCard class="shadow-sm">
            ...
            <CCardBody>
              <div class="d-flex justify-content-between align-items-center mb-2">
                <span class="text-muted">Cattle Count</span>
                <span class="badge bg-primary">{{ block.cattle_count || 0 }}</span>
              </div>
              <div class="d-flex justify-content-between align-items-center mb-2">
                <span class="text-muted">Utilization</span>
                <span class="badge bg-success">{{ block.utilization || '0%' }}</span>
              </div>
              <div class="d-flex justify-content-between align-items-center">
                <span class="text-muted">Health Score</span>
                <span class="badge bg-info">{{ block.health_score || 'N/A' }}</span>
              </div>
            </CCardBody>
          </CCard>
        </CCol>
