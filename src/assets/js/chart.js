$(function() {
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                pointHighlightStroke: "rgba(4, 202, 208 ,1)",
                fill: true,
    ...
    var datapie = {
        ...
        datasets: [{
            data: [20, 20, 30, 5, 25],
            backgroundColor: ['#564ec1', '#04cad0', '#09ad95', '#1170e4', '#e82646']
        }]
    };
    var optionpie = {
        maintainAspectRatio: false,
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: "rgba(86, 78, 193, .8)",
                borderWidth: "1",
                backgroundColor: "rgba(86, 78, 193, .4)"
            }, {
                label: "Data2",
                data: [28, 12, 40, 19, 63, 27, 87],
                borderColor: "rgba(4, 202, 208,0.8)",
                borderWidth: "1",
                backgroundColor: "rgba(4, 202, 208,0.4)"
            }]
        },
        options: {
            responsive: true,
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            datasets: [{
                data: [18, 15, 9, 6, 19],
                backgroundColor: ['#564ec1', '#04cad0', '#09ad95', '#1170e4', '#e82646'],
                hoverBackgroundColor: ['#564ec1', '#04cad0', '#09ad95', '#1170e4', '#e82646'],
