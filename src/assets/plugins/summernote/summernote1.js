		...
		52: function(t, e, n) {
			...
			var s = r.a.create('<div class="note-editor note-frame panel panel-default"/>'),
				...
				y = r.a.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', (function(t, e) {
					...
					'<div class="modal-header"><h6 class="modal-title">' + e.title + '</h6> <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" aria-hidden="true"></button></div>' : ""
