    ...
    if ($(".app").hasClass("sidenav-toggled")) {
      ...
      if (
        (document.querySelector("html").getAttribute("data-vertical-style") ===
          ...
          document.querySelector("html").getAttribute("data-vertical-style") ===
            "doublemenu-tabs") &&
        !document.querySelector("html").getAttribute("data-layout") ===
          "horizontal"
      ) {
      ...
      if (innerWidth >= 992) {
        if (
          (document
            ...
            document
              .querySelector("html")
              .getAttribute("data-vertical-style") === "doublemenu-tabs") &&
          !document.querySelector("html").getAttribute("data-layout") ===
            "horizontal"
        ) {
...
$(window).resize(() => {
  ...
  if (window.innerWidth >= 992) {
    if (
      ...
      var ul1 = parent1
        .find("ul.sub-slide-menu:visible")
...
$(document).on("click", "#slide-left", function () {
  ...
  let menuContainerWidth =
    menuWidth?.offsetWidth - mainSidemenuWidth?.offsetWidth;
  let marginLeftValue =
    Math.ceil(window.getComputedStyle(menuItems).marginLeft.split("px")[0]) +
    100;
  let marginRightValue =
    Math.ceil(window.getComputedStyle(menuItems).marginRight.split("px")[0]) +
    100;
